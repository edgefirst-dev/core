...
Similarly, you can override the session data by creating a `d.ts` file in your project with this content
...
declare module "@edgefirst-dev/core" {
  interface SessionData {
    // Add your custom session data here
  }
}
```

### Override Session Flash Data

Similarly, you can override the session flash data by creating a `d.ts` file in your project with this content
...
declare module "@edgefirst-dev/core" {
  interface SessionFlashData {
    // Add your custom session flash data here
  }
}
```
